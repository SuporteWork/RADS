...
rm -rf /root/ADDCInstaller && git clone https://github.com/SuporteWork/RADS.git /root/ADDCInstaller
...
rm -rf /root/FR-Installer && git clone https://github.com/SuporteWork/FR-RADS.git /root/FR-Installer
