...
# ========= OPTIMIZE DNF =========
optimize_dnf() {
  dialog --backtitle "System Preparation" --title "DNF Optimization" --infobox "Tuning DNF for faster downloads..." 5 50
  sleep 1
...
install_server_management() {
  ...
  GIT_REPO="https://github.com/SuporteWork/RADS-SM.git"
